...
/**
 * This class adds additional functionality to JSFML Vector2f. Im not even
 * allowed to modify the lib...
 */
public class Vec2f {
	/**
	...
	public static Vector2f normalize(Vector2f vec) {
		if (length(vec) == 0)
			System.out.println("Division by 0 (in normalize()).");
	 ...
	 * 
	 * @param vec
	 *            vector that is going to be measured.
	 ...
	 * @param vec2
	 *            the second vector.
	 * @return true if the first vector is bigger than the second one, false
	 *         otherwise.
	 */
	 ...
	 * @param vec2
	 *            the second vector.
	 * @return true if the first vector is smaller than the second one, false
	 *         otherwise.
	 */
